...
$(".dndclonedragged");a=$(".dndobject");d.css({top:b+n+"px",left:f+p+"px"});$(".intersected").removeClass("intersected");b=e.check(d,r,c);b.left&&!b.left.is(a)?(b.left.before(a),a.trigger("placed")):b.right&&!b.right.is(a)&&(b.right.after(a),a.trigger("placed"))}).off("mouseup.dndgrid").on("mouseup.dndgrid",function(){var a=$(".dndclonedragged"),b=$(".dndobject");e.off();b.removeClass("dndobject");var f=b.attr("style").replace(/opacity(\s+|)\:(\s+|)0(\;|)/,"");b.attr("style",f);a.detach();b.trigger("dropped")});
return!1})},off:function(a){$("body").unbind("mouseup.dndgrid").unbind("mousemove.dndgrid")},check:function(a,c,h){h=$(h).find(".dndsortactive").removeClass("intersected");var b=e.posdim(a),g=!1,d=!1;h.each(function(){var a=e.posdim($(this));c?(b.top>=a.top&&b.top<a.bottom-20&&(g=$(this).addClass("intersected")),b.top<=a.top&&b.bottom>a.top+20&&(d=$(this).addClass("intersected"))):(b.left<a.left&&b.right>a.left&&b.top>=a.top&&b.top<a.bottom-20?g=$(this).addClass("intersected"):b.left<a.left&&b.right>
a.left&&b.top<=a.top&&b.bottom>a.top+20&&(g=$(this).addClass("intersected")),b.left>a.left&&b.left<a.right&&b.top>=a.top&&b.top<a.bottom-20?d=$(this).addClass("intersected"):b.left>a.left&&b.left<a.right&&b.top<=a.top&&b.bottom>a.top+20&&(d=$(this).addClass("intersected")));if(g||d)return!1});return{right:d,left:g}},posdim:function(a){var c=a.offset(),e=a.outerWidth()||a.width();a=a.outerHeight()||a.height();c.bottom=c.top+a;c.right=c.left+e;c.height=a;c.width=e;return c}};$.fn.dndgrid=function(a){var c=
!1;a&&(c="undefined"==typeof a.trigger?!1:a.trigger);return this.each(function(){if($(this).data("dndgrid"))return!0;ori.addClass("dnd-placed");$(this).data("dndgrid",!0);e.activate($(this),c)})};$(function(){$(".dnd-grid .dnd-gridcell").dndgrid()})})();